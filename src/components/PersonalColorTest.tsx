...
const FAQ_DATA = [
  {q:"퍼스널 컬러 테스트가 정확한가요?",a:"사진 기반 알고리즘 분석으로 피부의 RGB 색상값, 웜/쿨 언더톤, 명도를 측정합니다. 자연광에서 촬영한 필터 없는 사진일수록 더 정확합니다."},
  {q:"어떤 사진을 업로드해야 하나요?",a:"얼굴이 중앙에 잘 보이는 정면 사진을 권장합니다. 자연광, 과도한 필터 없음, 최소한의 메이크업 상태가 이상적입니다."},
  {q:"사진은 어떻게 처리되나요?",a:"업로드된 사진은 브라우저 내에서만 처리되며 서버로 전송되지 않습니다. 분석은 완전히 로컬에서 이루어집니다."},
  {q:"퍼스널 컬러는 평생 바뀌지 않나요?",a:"기본 퍼스널 컬러는 크게 변하지 않지만, 나이·모발 염색·피부 태닝 등에 따라 서브타입이 달라질 수 있습니다."},
];
...
const CSS=`
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .fqa{font-size:12px;color:var(--sub);line-height:1.72;padding:0 16px 13px;}
